...
import { Container, SobreContainer, NosImportamosContainer, ObjetivoContainer, ImgContainer } from './styles';
  ...
  return (
    <Container>
      ...
      <Row id="nosImportamos">
        ...
        <NosImportamosContainer xs={12} sm={8}>
          <Text size={22} entryAnimation center="xs" bold className="title">
            NÓS NOS IMPORTAMOS
          </Text>

          <Text size={18} entryAnimation center="xs">
            Temos o propósito de trazer facilidades aos nossos clientes, sempre levando muita informação e facilitando o
            dia a dia do empresário, através de um excelente planejamento claro e estratégico, deixando-os disponíveis
            para focar no dia a dia de seu empreendimento.
          </Text>
          <Text size={18} entryAnimation center="xs">
            ...
            nossos clientes, para que assim possam ter tempo mais livre para se dedicar as suas atividades empresariais.
          </Text>
        </NosImportamosContainer>
      </Row>

      <Row>
        <ObjetivoContainer xs={12} sm={8}>
          <Text size={22} entryAnimation center="xs" bold className="title">
            NOSSO OBJETIVO
          </Text>

          <Text size={18} entryAnimation center="xs">
            Trazer soluções ao empresário com ética, transparência e responsabilidade, para que o mesmo possa se dedicar
            com tranquilidade as suas atividades operacionais, auxiliando em seu crescimento.
          </Text>
          <Text size={18} entryAnimation center="xs">
            Prestar serviços de excelência, com cumprimentos de todos os prazos, atendendo os requisitos legais,
            proporcionando serviços cm qualidade e melhorias contínuas, buscando atingir a plena satisfação do cliente.
          </Text>
        </ObjetivoContainer>
