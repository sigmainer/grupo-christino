...
import { Presentation, ServicosContainer, TextContainer, ImgContainer } from '~/styles/pages/home';

const Home: NextPage = () => (
  <>
    <Head>
      <title>Christino Consultoria</title>
    </Head>
    <>
      <Presentation>
        <Row>
          ...
          <Col xs={false} sm={false} md={4}>
            <img src="assets/contabilidade1.svg" alt="contabilidade" />
          </Col>
        </Row>
      </Presentation>
